...
public class BookingRepository extends AbstractRepository { // inheritance semua ke abstract class
    ...
    public int add(Object element) throws SQLException {
        ...
        PreparedStatement ps = super.conn.prepareStatement(insertQuery); // refer ke abstractrepository
        ps.setInt(1, booking.getUser().getId()); // buat isi tanda tny line 16
    ...
    private Object executeQuery(PreparedStatement ps) throws SQLException { //menerima return data
        ResultSet rs = ps.executeQuery();
        ...
        while (rs.next()) {
            ...
            ls.add(booking); // nge add smua booking tiap 1 row
        }
        return ls;
    }
    ...
    @Override
    public Object delete(int id) throws SQLException { // buat cancel transaksi
